...
SRC = \
  src/ast/ms_create_command_node.c \
  src/ast/ms_create_node.c \
  src/ast/ms_parse_command.c \
  src/ast/ms_parse_tokens.c \
  src/ast/ms_parse_logical.c \
  src/ast/ms_parse_pipeline.c \
  src/ast/ms_parse_redirection.c \
  src/ast/ms_parse_subshell.c \
  src/ast/ms_print_ast.c \
  src/ast/ms_utils.c \
  src/ast/ms_utils2.c \
  ...
  src/builtins/ms_copy_env_list.c \
  src/builtins/ms_echec_malloc.c \
  src/builtins/ms_pwd.c \
  src/builtins/ms_builtins_utils.c \
  ...
  src/syntax_error/ms_check_error.c \
  src/syntax_error/ms_check_reinit.c \
  src/syntax_error/ms_operator_gestion.c \
  src/syntax_error/ms_parenthesis_gestion.c \
  src/syntax_error/ms_quote_gestion.c \
  src/syntax_error/ms_redir_gestion.c \
  src/syntax_error/ms_syntax_error.c \
  src/token/ms_lst_tokens.c \
  src/token/ms_tokenize.c \
  src/token/ms_tokenize_frame.c \
  src/token/ms_tokenize_operator.c \
  src/token/ms_tokenize_word_helper.c \
  src/token/ms_utils.c \
  src/token/ms_tokenize_word.c \
  src/ms_global.c 
