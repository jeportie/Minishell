...
/*   Updated: 2024/10/09 21:33:49 by jeportie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct s_background_node
{
	struct s_ast_node	*child;
}				t_background_node;
...
t_ast_node	*create_sequence_node(int count, t_ast_node **commands, t_gc *gcl);
t_ast_node	*create_background_node(t_ast_node *child, t_gc *gcl);
